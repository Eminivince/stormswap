...
function TokenModalSwapFrom() {
  ...
  return (
    <div className="">
      <div className="bg-[#351349b8] fixed w-full h-fit min-h-[100vh] top-0 left-0 backdrop-blur-[4px] z-50"></div>
      <div className="bg-purple-900 w-full max-w-[464px] sm:w-[464px] h-[564px] p-4 absolute top-8 left-1/2 -translate-x-1/2 z-50 rounded-xl flex flex-col">
        ...
        <div className="relative mb-4">
          <input
            ...
            className="bg-[#e0d8d8] w-full h-[56px] rounded-xl pl-3 pr-9 outline-none"
          />
          <i className="absolute right-2 top-1/2 -translate-y-1/2 text-white[24px] text-purple-800">
            <AiOutlineSearch />
          </i>
        </div>
        ...
        {searchToken.filteredToken && (
          <div
            className="h-[48px] w-full max-w-[384px] sm:w-[384px] m-auto bg-[#e0d8d8] rounded-[100px] flex items-center justify-center"
...
export const Item = ({ token, signer, searchToken, selectToken, type }) => {
  ...
  return (
    <button
      ...
      className="flex items-center w-full h-[72px] bg-[#e0d8d8] border border-purple-800 px-2 mb-3 rounded-xl cursor-pointer"
    ...
    >
      ...
      <div className="ml-auto">
        {!Token_List.find((t) => t.address === token.address) ? (
          <div
            className="bg-purple-800 w-[75px] h-[32px] rounded-xl text-white hover:opacity-70"
